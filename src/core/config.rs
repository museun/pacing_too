...
pub static OFFENSE_ATTRIBUTE: &[Modifier] = &[
...
pub static DEFENSE_ATTRIBUTE: &[Modifier] = &[
...
pub static OFFENSE_QUIRK: &[Modifier] = &[
    Modifier::new("Dull", -2),
...
pub static DEFENSE_QUIRK: &[Modifier] = &[
...
pub static SHIELDS: &[EquipmentPreset] = &[
...
pub static ARMORS: &[EquipmentPreset] = &[
...
pub static ITEM_ATTRIBUTES: &[&str] = &[
    "Golden",
    "Gilded",
    "Spectral",
    "Astral",
...
pub static ITEM_PREPOSITION: &[&str] = &[
    "Foreboding",
    "Foreshadowing",
    "Nervousness",
    "Happiness",
...
pub static WEAPONS: &[EquipmentPreset] = &[
...
pub static IMPRESSIVE_TITLES: &[&str] = &[
    "King",
    "Queen",
    "Lord",
    "Lady",
